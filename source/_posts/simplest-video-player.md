---
title: 最简单的视频播放器
date: 2025-01-12 12:33:41
updated: 2025-01-12 12:33:41
tags:
- ffmpeg
- sdl
categories:
...
## FFmpeg 解码流程
FFmpeg 解码流程如下图所示：
![FFmpeg 解码流程](/images/av/ffmpeg-decode-flow.jpg "FFmpeg 解码流程")

解码过程中涉及如下的对象：
![FFmpeg 解码流程](/images/av/ffmpeg-decoding.png "FFmpeg 解码流程")
...
SDL 整体的显示流程如下所示：
![SDL 显示流程](/images/av/sdl-display-flow.jpg "SDL 显示流程")
...
这些对象之间的关系如下图所示：
![SDL 对象关系](/images/av/sdl-object-rel.jpg "SDL 对象关系")

下图举了个例子，指定了4个SDL_Rect，可以实现4分屏的显示。
![SDL 4分屏](/images/av/sdl-4-screen.jpg "SDL 4分屏")
...
github地址：<https://github.com/noahsarkzhang-ts/simple-video-player>
